...
public final class AppUtil {
    ...
    public static boolean isServiceRunning(Context context, String className) {
        ...
        ActivityManager activityManager = (ActivityManager) context.getSystemService(Context
                .ACTIVITY_SERVICE);
        List<RunningServiceInfo> servicesList = activityManager.getRunningServices(Integer
                .MAX_VALUE);
    ...
    /**
     * 判断应用是否后台运行，调用需要permission：android.permission.GET_TASKS
     *
     * @param context 上下文
     * @return
     */
    ...
    public static String getCurrentRuntimeValue() {
        try {
            ...
            try {
                ...
                try {
                    final String value = (String) get.invoke(systemProperties, "persist.sys" + "" +
                                    ".dalvik.vm.lib",
    ...
    private final static X500Principal DEBUG_DN = new X500Principal("CN=Android Debug,O=Android,"
            + "C=US");
    ...
    /**
     * 获取设备唯一标识 调用需要READ_PHONE_STATE权限
     *
     * @param context
     * @return
     */
    public static String getUUID(Context context) {
        ...
        if (ActivityCompat.checkSelfPermission(context, Manifest.permission.READ_PHONE_STATE) ==
            ...
            Log.e("AppUtil", "没有 android.permission.READ_PHONE_STATE 权限");
            tmDevice = "device";
            tmSerial = "serial";
            androidId = "androidid";
        }
